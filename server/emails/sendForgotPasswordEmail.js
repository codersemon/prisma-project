                ...
                <td>
                    ...
                    <table class="contant-table" style="margin-top: 40px;" align="center" border="0" cellpadding="0"
                        ...
                        <thead>
                            <tr style="display: block;">
                                ...
                                <td style="display: block;">
                                    <h3
                                        style="font-weight: 700; font-size: 20px; margin: 0;color: #939393;margin-top: 15px; text-align: center !important;">
                                        Hi Julie Griffin,</h3>
                                </td>

                                <td style="display: block;">
                                    <p
                                        style="font-size: 17px;font-weight: 600;margin: 8px auto 0;line-height: 1.5;color: #939393; margin: auto;">
                    ...
                    <table class="button-table" style="margin-top: 27px;" align="center" border="0" cellpadding="0"
                        ...
                        <thead>
                            <tr style="display: block;">
                                <td style="display: block;">
                                    <h1 style="text-align: center;">Your OTP: ${otp}</h1>
                                </td>
                            </tr>
                        </thead>
                    </table>
                    ...
                    <table class="contant-table" style="margin-top: 27px;" align="center" border="0" cellpadding="0"
                        ...
                        <thead>
                            <tr style="display: block;">
                                <td style="display: block;">
                                    <p
                                        style="font-size: 17px;font-weight: 600;width: 74%;margin: 8px auto 0;line-height: 1.5;color: #939393; text-align: center;">
                    ...
                    <table class="text-center footer-table" align="center" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td>
                                    ...
                                    <tr>
                                        <td>
                                            <h4 style="font-size: 19px; font-weight: 700; margin: 0;">Shop For <span
                                                    class="theme-color">Greenkart</span></h4>
                                        </td>
                                    </tr>
                                </table>
                                <table border="0" cellpadding="0" cellspacing="0" class="footer-social-icon text-center"
                                ...
                                letter-spacing:1px; font-weight: 500;">2021-22 copyright by Emon Khan</h5>
                                        </td>
                                    </tr>
                                </table>
                            </td>
