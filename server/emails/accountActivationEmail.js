...
export const sendAccountActivationEmail = async (email, otp, link) => {
                ...
                <td>
                    ...
                    <table class="button-table" style="margin: 34px 0;" align="center" border="0" cellpadding="0"
                        ...
                        <thead>
                            ...
                            <tr style="display: block;">
                                <td style="display: block; text-align: center; margin-top: 20px;">
                                    <a href=${link} class="password-button" style="color: #fff;">Verify Email</a>
                                </td>
                            </tr>
                        </thead>
                    </table>
